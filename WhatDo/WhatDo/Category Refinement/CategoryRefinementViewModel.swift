...
struct CategoryRefinementViewModel {
    ...
    var diningCategory: [RefinementCardViewModel] {
        ...
        let questionFour = RefinementCardViewModel(leftLabel: "Card4: A", rightLabel: "Card2: B", sfSymbol: utensils)
    ...
    var drinksCategory: [RefinementCardViewModel]{
        ...
        let questionFour = RefinementCardViewModel(leftLabel: "Card4: A", rightLabel: "Card2: B", sfSymbol: drink)
    ...
    var cinemaCategory: [RefinementCardViewModel]{
        ...
        let questionFour = RefinementCardViewModel(leftLabel: "Card4: A", rightLabel: "Card2: B", sfSymbol: popcorn)
    ...
    var eventsCategory: [RefinementCardViewModel]{
        ...
        let questionFour = RefinementCardViewModel(leftLabel: "Card4: A", rightLabel: "Card2: B", sfSymbol: mic)
    ...
    var activitiesCategory: [RefinementCardViewModel]{
        ...
        let questionFour = RefinementCardViewModel(leftLabel: "Card4: A", rightLabel: "Card2: B", sfSymbol: mountain)
    ...
    var nightOutCategory: [RefinementCardViewModel]{
        ...
        let questionFour = RefinementCardViewModel(leftLabel: "Card4: A", rightLabel: "Card2: B", sfSymbol: drink, sfSymbol2: utensils, sfSymbol3: mic)
