...
class SwipeableViewGestures: UIView {
    ...
    private func setupGestureRecognizers() {
        ...
        let panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(SwipeableViewGestures.panGestureRecognized(_:)))
    ...
    @objc private func panGestureRecognized(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        case .changed:
            let rotationStrength = min(panGestureTranslation.x / frame.width, SwipeableViewGestures.maximumRotation)
            let rotationAngle = SwipeableViewGestures.animationDirectionY * SwipeableViewGestures.rotationAngle * rotationStrength
    ...
    private func endedPanAnimation() {
        if let dragDirection = dragDirection, dragPercentage >= SwipeableViewGestures.swipePercentageMargin {
            ...
            translationAnimation?.duration = SwipeableViewGestures.finalizeSwipeActionAnimationDuration
    ...
    private func resetCardViewPosition() {
        ...
        resetPositionAnimation?.springBounciness = SwipeableViewGestures.cardViewResetAnimationSpringBounciness
        resetPositionAnimation?.springSpeed = SwipeableViewGestures.cardViewResetAnimationSpringSpeed
        ...
        resetRotationAnimation?.duration = SwipeableViewGestures.cardViewResetAnimationDuration
